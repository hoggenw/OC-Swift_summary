...
#import "MainTarbBarController.h"
#import "NavigationController.h"



@interface MainTarbBarController () <UITabBarControllerDelegate>
...
@implementation MainTarbBarController
...
{
    // 包装成导航控制器
    UINavigationController *nc = [[NavigationController alloc] initWithRootViewController:childVC];
