...
//
//==============================================================================
@implementation UIImage (PisenKit_QRCode)
+ (UIImage *)psk_createQRCodeImageWithString:(NSString *)string size:(CGSize)size {
    CIImage *ciImage = [self _psk_createQRForString:string];
    return [self _psk_createNonInterpolatedUIImageFormCIImage:ciImage withSize:size.width];
}
 ...
 */
+ (CIImage *)_psk_createQRForString:(NSString *)qrString {
 ...
 */
+ (UIImage *)_psk_createNonInterpolatedUIImageFormCIImage:(CIImage *)image withSize:(CGFloat) size {
