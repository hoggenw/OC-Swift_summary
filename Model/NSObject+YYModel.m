...
#pragma mark- _YYModelPropertyMeta 对Model的property进行解析与构造(.m中的private类)
...
#pragma mark- _YYModelMeta类的声明与回调 对Model进行解析与构造(.m中的private类)
...
#pragma mark - 基于NSObject 的category 添加数据转换为模型的方法
@implementation NSObject (YYModel)
#pragma mark - 确保数据类型转为字典类型
...
#pragma mark -  Creates and returns a new instance of the receiver from a json.
...
#pragma mark -  Creates and returns a new instance of the receiver from a key-value dictionary.
